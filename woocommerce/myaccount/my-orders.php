...
$my_orders_columns = apply_filters( 'woocommerce_my_account_my_orders_columns', array(
	'order-number'  => __( 'Order', 'freeshop' ),
	'order-date'    => __( 'Date', 'freeshop' ),
	'order-status'  => __( 'Status', 'freeshop' ),
	'order-total'   => __( 'Total', 'freeshop' ),
	'order-actions' => '&nbsp;',
) );
...
if ( $customer_orders ) : ?>
	...
	<h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'freeshop' ) ); ?></h2>
